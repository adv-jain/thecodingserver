      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="caption">
            ...
            <h2>Learn to code online <br>at your own pace</h2>
            <p>
              Our online coding classes are perfect for beginners and professionals alike who want to learn to code
              for the first time. With
              our easy-to-follow lessons and video tutorials, you'll be up and coding in no time.
            </p>
        ...
        <div class="owl-service-item owl-carousel">
          ...
          <div class="item">
            ...
            <div class="down-content">
              ...
              <p>Top courses that are a value for time and money.Get certified and be prepared for better
                opportunities.
              </p>
            </div>
          </div>
          ...
          <div class="item">
            ...
            <div class="down-content">
              ...
              <p>
                Coding skills are more valuable than ever! Master them from scratch or level-up with our online
                classes.
                <!-- coding skills are more valuable than ever.  Whether you're a complete beginner or looking to refine your expertise, our online coding classes offer a path to transform your future -->
              </p>
            </div>
          </div>
          ...
          <div class="item">
            ...
            <div class="down-content">
              <h4>Educator Help</h4>
              <p>Demonstrate the topic with examples though Market visit & Industry survey to learn the practical way
                of using material and applying techniques.</p>
            </div>
          </div>
          ...
          <div class="item">
            ...
            <div class="down-content">
              ...
              <p>
                Weekdays & Weekend classes with flexible timings that allow you to never miss a class. Convenient and
          ...
          <div class="item">
            ...
            <div class="down-content">
              ...
              <p>Online learning is a platform for professionals to get certified with required skills along with
                their jobs. </p>
            </div>
          </div>
    ...
    <div class="row">
      ...
      <div class="col-lg-4">
        <div class="categories">
          <h4>Batches Catgories</h4>
          <ul class="d-flex flex-column">
            <li><a href="#">Python</a>
              <!-- <span class="bg-primary p-1 px-2 small text-white rounded-circle">3</span> -->
            </li>
          ...
          <div class="main-button-red">
            <a href="meetings.html">All Upcoming Batches</a>
          </div>
        </div>
      </div>
      <div class="col-lg-8">
        <div class="row">
          <div class="col-lg-6">
            <div class="meeting-item">
              ...
              <div class="down-content">
                <div class="date">
                  <h6>Coming <span>Soon</span></h6>
                </div>
                <a href="meeting-details.html">
                  <h4>Beginner Python Class</h4>
                </a>
                <p>Learn the basics of python. Build Solid Foundation. Crack Upcoming Exams.</p>
              </div>
            </div>
          </div>
          <div class="col-lg-6">
